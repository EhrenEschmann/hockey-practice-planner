...
const RUNTIME_HOSTS = ['https://www.gstatic.com/firebasejs/', 'https://cdn.jsdelivr.net/npm/@anthropic-ai/sdk']; // the Firebase and Anthropic SDK modules are cached too
